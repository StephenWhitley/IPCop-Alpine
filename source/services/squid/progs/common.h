...
/* Standard Paths */
#define IPCOP_WEB_ROOT  "/var/www/ipcop/html"
#define IPCOP_CGI_ROOT  "/var/www/ipcop/cgi-bin"
#define IPCOP_LOG_ROOT  "/var/log"
...
extern char mac_buffer[STRING_SIZE]; /* to return the value out of the function */
