...
# Add entries in menu
# MENU!ENTRY status 040 "system graphs" "system graphs"
# MENU!ENTRY status 050 "sstraffic graphs" "network traffic graphs" "?graph=network"
#
...
my $graphdir = '/var/www/ipcop/html/graphs';
