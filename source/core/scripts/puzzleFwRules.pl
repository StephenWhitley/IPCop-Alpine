...
#~
#~ /usr/sbin/iptables -t nat -A PORTFW -p tcp -d 192.168.11.190 --dport 123 -j DNAT --to 1.1.1.1:456
#~ /usr/sbin/iptables -t mangle -A PORTFWMANGLE -p tcp -s 192.168.2.190/255.255.255.0 -d 192.168.11.190 --dport 123 -j MARK --set-mark 1
#~ /usr/sbin/iptables -t mangle -A PORTFWMANGLE -p tcp -s 192.168.3.190/255.255.255.0 -d 192.168.11.190 --dport 123 -j MARK --set-mark 21
#~ /usr/sbin/iptables -t mangle -A PORTFWMANGLE -p tcp -s 192.168.4.190/255.255.255.0 -d 192.168.11.190 --dport 123 -j MARK --set-mark 31
#~ /usr/sbin/iptables -A PORTFWACCESS -i eth1 -p tcp -s 2.2.2.2 -d 1.1.1.1 --dport 456 -j ACCEPT
...
#~ /usr/sbin/iptables -t mangle -A PORTFWMANGLE -p tcp -s 192.168.3.190/255.255.255.0 -d 192.168.11.190 --dport 123 -j MARK --set-mark 21
#~ /usr/sbin/iptables -t mangle -A PORTFWMANGLE -p tcp -s 192.168.4.190/255.255.255.0 -d 192.168.11.190 --dport 123 -j MARK --set-mark 31
#~ /usr/sbin/iptables -A PORTFWACCESS -i eth1 -p tcp -s 0.0.0.0/0 -d 1.1.1.1 --dport 456 -j ACCEPT
...
#~ /usr/sbin/iptables -t mangle -A PORTFWMANGLE -p tcp -s 192.168.4.190/255.255.255.0 -d 192.168.11.190 --dport 123 -j MARK --set-mark 31
#~ /usr/sbin/iptables -A PORTFWACCESS -i eth1 -p tcp -s 2.2.2.2 -d 1.1.1.1 --dport 456 -j ACCEPT
#~ /usr/sbin/iptables -A PORTFWACCESS -i eth1 -p tcp -s 3.3.3.3 -d 1.1.1.1 --dport 456 -j ACCEPT
...
#~         internal IP:        1.1.1.1
#~
#~ /usr/sbin/iptables -t nat -A PORTFW -p gre -d 192.168.11.190 -j DNAT --to 1.1.1.1
#~ /usr/sbin/iptables -A PORTFWACCESS -i eth1 -p gre -s 0.0.0.0/0 -d 1.1.1.1 -j ACCEPT
...
sub prepareRuleDirect
{
    ...
    push(@preparedRules, "/usr/sbin/iptables $rule");
}
