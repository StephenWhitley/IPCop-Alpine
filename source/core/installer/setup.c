...
int main(int argc, char **argv)
{
    ...
    menuchoices[0] = gettext("TR_TIMEZONE");
    menuchoices[1] = gettext("TR_HOSTNAME");
    menuchoices[2] = gettext("TR_DOMAINNAME");
    menuchoices[3] = gettext("TR_NETWORKING");
    menuchoices[4] = gettext("TR_PASSWORDS");
    menuchoices[5] = NULL;
