...
#define errorbox(msg)                                                          \
  newtWinMessage(gettext("TR_ERROR"), gettext("TR_OK"), (msg))
...
int mysystem_progress(char *command, void *form, int left, int top, int width,
...
extern int changed_config; /* something has changed      */
