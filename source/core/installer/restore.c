...
#define DATFILE_FULL                "/harddisk" IPCOP_WEB_ROOT "/backup/ipcop-xxxx-xx-xx_xx-xx-xx.dat"
#define DATFILE_CHROOT              IPCOP_WEB_ROOT "/backup/ipcop-xxxx-xx-xx_xx-xx-xx.dat"
...
static int copy_change_files(void)
{
    ...
    mysystem("chroot /harddisk /usr/bin/upgrade.sh");
...
static int restorefromusb(char *hostname, char *password)
{
    ...
    snprintf(command, STRING_SIZE, "chroot /harddisk /usr/bin/ipcoprestore"
